...
<body>
    <form action="/confim/payment1.php" method="post">
        ...
        <div class="form-group">
            <input type="text" placeholder="ชื่อ-สกุล" name="txtFormName">
            <div class="bio">
                <input type="text" placeholder="เบอร์โทร" id="txtphone" name="txtphone">
                <input type="text" placeholder="จำนวนเงิน" id="txttotal" name="txttotal">
            </div>
                <input type="email" name="txtFormEmail" placeholder="E-mail">
                <br>
